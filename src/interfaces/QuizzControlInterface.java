...
// rev pelo 25-11-2013
    ...
    /**
     * Pre: Post: Returns a list of names of selectable games
     */
    String[] getGameNames();

    /**
     * Pre: The name passed corresponds to a selectable game Post: The existing
     * collection of word pairs is cleared.
     */
    void selectGame(String gameName);

    /**
     * Pre: Post: Returns the name of the game presently selected. If no game is
